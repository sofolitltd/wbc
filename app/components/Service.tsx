        ...
        <div className="grid gap-y-6 md:grid-cols-2 lg:grid-cols-4 mx-auto gap-x-4 my-12 md:my-14">
            ...
            <div className="w-full bg-green-100/50 rounded-lg p-4 h-full">
              ...
              <div className="flex justify-between items-center">
                <p className="text-md font-medium text-slate-600">
                  <a href={calendarLink} target="_blank" rel="noopener noreferrer">Explore More</a>
                </p>
          ...
          <div className="">
            <div className="w-full bg-indigo-100/75 rounded-lg p-4 h-full">
              ...
              <p className="my-3 text-sm text-slate-500">
                Couple therapy for married couples in known as marital therapy.
                Individual sessions may be provided separately.
              </p>
              <div className="my-4 h-0.5 bg-gray-500/25"></div>
              <div className="flex justify-between items-center">
                <p className="text-md font-medium text-slate-600">
          ...
          <div className="">
            <div className="w-full bg-orange-100/50 rounded-lg p-4 h-full">
              ...
              <p className="my-3 text-sm text-slate-500">
                With counseling, teens participate in talk therapy in a safe environment with a mental health professional.
              </p>
              <div className="my-4 h-0.5 bg-gray-500/25"></div>
              <div className="flex justify-between items-center">
                <p className="text-md font-medium text-slate-600">
          ...
          <div className="">
            <div className="w-full bg-pink-100/50 rounded-lg p-4 h-full">
              <p className="font-bold text-lg text-slate-700">Psychiatry</p>
              <p className="my-3 text-sm text-slate-500">
                Evaluation and medication management are usually carried out by psychiatrists or, in many states.
              </p>
              <div className="my-4 h-0.5 bg-gray-500/25"></div>
              <div className="flex justify-between items-center">
                <p className="text-md font-medium text-slate-600">
